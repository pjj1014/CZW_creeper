...
class Ui_LoginDialog(object):
    ...
    def retranslateUi(self, LoginDialog):
        LoginDialog.setWindowTitle(
            QCoreApplication.translate("LoginDialog", u"\u722c\u866b\u8ba1\u5212-\u767b\u5f55\u754c\u9762", None))
        self.label.setText(QCoreApplication.translate("LoginDialog",
                                                      u"<html><head/><body><p align=\"justify\">\u7528\u6237\u540d:</p></body></html>",
                                                      None))
        self.label_2.setText(QCoreApplication.translate("LoginDialog",
                                                        u"<html><head/><body><p align=\"justify\">\u5bc6   \u7801:</p></body></html>",
                                                        None))
