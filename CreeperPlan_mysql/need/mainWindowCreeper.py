...
from PySide6.QtWidgets import (QCheckBox, QComboBox, QDateEdit,
                               ...
                               QHBoxLayout, QLabel, QLineEdit, QPlainTextEdit, QProgressBar, QPushButton, QRadioButton,
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate("MainWindow", u"\u722c\u866b\u8ba1\u5212-\u4e3b\u754c\u9762", None))
        ...
        self.cb_dateChoose.setText(
            QCoreApplication.translate("MainWindow", u"\u662f\u5426\u9009\u62e9\u65e5\u671f", None))
        self.label.setText(QCoreApplication.translate("MainWindow",
                                                      u"<html><head/><body><p align=\"center\">\u7528\u6237\u540d:</p></body></html>",
                                                      None))
        self.label_2.setText(QCoreApplication.translate("MainWindow",
                                                        u"<html><head/><body><p align=\"center\">\u5bc6\u7801:</p></body></html>",
                                                        None))
        ...
        self.pte_clean_gjc.setPlaceholderText(QCoreApplication.translate("MainWindow",
                                                                         u"\u5982\u5bf9\u6807\u9898\u4e2d\u542b\u6709\u7684\u67d0\u4e9b\u5173\u952e\u8bcd\uff0c\u8fd8\u6709\u53e6\u5916\u4e8c\u6b21\u6e05\u7406\u7684\u9700\u6c42\uff0c\u8bf7\u5728\u6b64\u586b\u5199\uff0c\u591a\u4e2a\u5173\u952e\u8bcd\u53ef\u7528\u82f1\u6587\u9017\u53f7\u201c,\u201d\u9694\u5f00",
                                                                         None))
        ...
        self.label_16.setText(
            QCoreApplication.translate("MainWindow", u"\u81ea\u5b9a\u4e49\u91d1\u989d(\u4e07\u5143)", None))
        ...
        self.le_driverPath.setPlaceholderText(
            QCoreApplication.translate("MainWindow", u"\u6d4f\u89c8\u5668\u9a71\u52a8\u8def\u5f84", None))
        ...
        self.rb_fullTextInclludingAttachments.setText(
            QCoreApplication.translate("MainWindow", u"\u5168\u6587\u641c\u7d22\u542b\u9644\u4ef6", None))
        self.rb_titleSearch.setText(QCoreApplication.translate("MainWindow", u"\u6807\u9898\u641c\u7d22 ", None))
        self.rb_fullTextNoAttachment.setText(
            QCoreApplication.translate("MainWindow", u"\u5168\u6587\u641c\u7d22\u4e0d\u542b\u9644\u4ef6", None))
        self.label_3.setText(
            QCoreApplication.translate("MainWindow", u"\u8f93\u5165\u641c\u7d22\u5173\u952e\u8bcd", None))
        self.te_searchBox.setPlaceholderText(
            QCoreApplication.translate("MainWindow", u"\u8bf7\u8f93\u5165\u641c\u7d22\u5173\u952e\u8bcd", None))
        ...
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"\u7b5b\u9009\u7684\u884c\u4e1a\n"
                                                                       "\u5173\u952e\u8bcd", None))
        self.te_hy.setPlaceholderText(QCoreApplication.translate("MainWindow",
                                                                 u"\u8bf7\u8f93\u5165\u8981\u4ece\u6807\u9898\u4e2d\u7b5b\u9009\u7684\u884c\u4e1a\u5173\u952e\u8bcd\u5f52\u7eb3\uff0c\u591a\u4e2a\u5173\u952e\u8bcd\u53ef\u7528\u82f1\u6587\u9017\u53f7\",\"\u9694\u5f00",
                                                                 None))
        self.rb_cleanGjc.setText(QCoreApplication.translate("MainWindow",
                                                            u"\u9700\u6e05\u7406\u6807\u9898\u4e2d\u542b\u6709\u7684\u5173\u952e\u8bcd",
                                                            None))
        self.rb_saveGjc.setText(QCoreApplication.translate("MainWindow",
                                                           u"\u4ec5\u4fdd\u7559\u6807\u9898\u4e2d\u542b\u6709\u7684\u5173\u952e\u8bcd",
                                                           None))
        self.pte_cleanORsave_gjc.setPlaceholderText(QCoreApplication.translate("MainWindow",
                                                                               u"\u8bf7\u9009\u62e9\u9700\u8981\u6e05\u7406\u6807\u9898\u4e2d\u542b\u6709\u67d0\u4e2a\u5173\u952e\u8bcd\u7684/\u4ec5\u4fdd\u7559\u6807\u9898\u4e2d\u542b\u6709\u67d0\u4e2a\u5173\u952e\u8bcd\u7684\uff0c\u591a\u4e2a\u5173\u952e\u8bcd\u53ef\u7528\u82f1\u6587\",\"\u9694\u5f00",
                                                                               None))
        self.btn_choosePosition.setText(
            QCoreApplication.translate("MainWindow", u"\u9009\u62e9\u5b58\u50a8\u4f4d\u7f6e", None))
        self.le_tablePath.setPlaceholderText(
            QCoreApplication.translate("MainWindow", u"\u6587\u4ef6\u8def\u5f84", None))
        self.btn_homePageSearch.setText(
            QCoreApplication.translate("MainWindow", u"\u4e3b\u9875\u9762\u641c\u7d22", None))
        self.btn_searchPageSearch.setText(
            QCoreApplication.translate("MainWindow", u"\u641c\u7d22\u9875\u9762\u641c\u7d22", None))
        ...
        self.te_gjc.setPlaceholderText(QCoreApplication.translate("MainWindow",
                                                                  u"\u8bf7\u8f93\u5165\u8981\u4ece\u6807\u9898\u4e2d\u7b5b\u9009\u7684\u5173\u952e\u8bcd\u5f52\u7eb3\uff0c\u591a\u4e2a\u5173\u952e\u8bcd\u53ef\u7528\u82f1\u6587\u9017\u53f7\",\"\u9694\u5f00",
                                                                  None))
        ...
        self.label_7.setText(
            QCoreApplication.translate("MainWindow", u"\u91c7\u62db\u7f51\u6293\u53d6\u4fe1\u606f", None))
